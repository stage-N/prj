...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <text x="80" y="360" fill="${GREEN}" font-family="system-ui,sans-serif" font-size="36" font-weight="600">Banjem — Korean news stance comparison</text>
  <text x="80" y="420" fill="#aaaaaa" font-family="system-ui,sans-serif" font-size="28">One news, five perspectives.</text>
